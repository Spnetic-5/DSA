...
def draw_the_lines(img, lines, height, width):
    ...
    for line in lines:
        for x1, y1, x2, y2 in line:
            img_line =cv2.rectangle(img, (x1, y1), (x2, y2),
                     (0, 255, 0), thickness=2)
    ...
    img = cv2.rectangle(img_line, (px1, py1), (px2, py2) , (0, 0, 255), 2)
    img2 = cv2.rectangle(img, (250, 830), (width-250, height-170) , (0, 0, 255), 2)
