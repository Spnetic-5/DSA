...
def draw_left_weighted_line(img, line, color=[255, 0, 0], thickness=2, alpha = 1.0, beta = 0.95, gamma= 0):
...
def draw_right_weighted_line(img, line, color=[0, 255, 0], thickness=2, alpha = 1.0, beta = 0.95, gamma= 0):
    mask_img = np.zeros_like(img)
